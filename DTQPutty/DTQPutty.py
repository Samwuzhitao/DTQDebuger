...
class DTQPutty(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.tree_com.setFixedHeight(150)
        ...
        self.dock_com1 = QDockWidget(u"智能过滤",self)
        self.dock_com1.setFeatures(QDockWidget.DockWidgetMovable)
        self.dock_com1.setAllowedAreas(Qt.LeftDockWidgetArea|Qt.RightDockWidgetArea)

        self.tree_com1 = QWidget()
        self.pro_lineedit = QLineEdit()
        self.pro_label = QLabel(u"过滤关键字:")
        yyk_layout = QVBoxLayout()
        yyk_layout.addWidget(self.pro_label)
        yyk_layout.addWidget(self.pro_lineedit)
        self.tree_com1.setLayout(yyk_layout)

        self.tree_com1.setFixedWidth(150)
        self.tree_com1.setFixedHeight(60)
        self.dock_com1.setWidget(self.tree_com1)
        self.addDockWidget(Qt.LeftDockWidgetArea,self.dock_com1)
